# -*- coding: utf-8 -*-
# ------------------------------------------------------------------
# Filename: g_kwargs.py
#  Purpose: Plotting g_kwargs of Seismograms.
...
# --------------------------------------------------------------------
"""
Plotting g_kwargs of seismograms.
...
def spectrogram(tr, samp_rate, per_lap=0.9, wlen=None, log=False,  # JJW
# def g_kwargs(data, samp_rate, per_lap=0.9, wlen=None, log=False,
                outfile=None, fmt=None, axes=None, dbscale=False,
                mult=8.0, cmap=obspy_sequential, zorder=None, title=None,
                show=True, clip=[0.0, 1.0]):
    """
    Computes and plots g_kwargs of the input data.
    ...
    ax.xaxis_date()  # JJW
    time = np.array(starttime) + time  # JJW
    import matplotlib.dates as mdates  # JJW
    time = [mdates.date2num(t.datetime) for t in time]  # JJW
    if log:
