...
class Helicorder(object):
    ...
    def __init__(self, st, *args, **kwargs):
        ...
        # Whether to use straight swarmmpl or the fast minmax method. If not
        ...
        # Color of the graph.
        self.color = kwargs.get('color', swarm_colors_hex)
        # if self.type == 'dayplot':
    ...
    def plot_tags(self, times, marker="o", color="red", markersize=8, markeredgecolor="black", verbose=False, **kwargs):
    ...
    def __dayplot_set_y_ticks(self, *args, **kwargs):  # @UnusedVariable
        ...
        if intervals <= 5 or self.one_tick_per_line:
            ...
            ticks -= 0.5
        ticks = np.append(ticks, 0)  # JJW: Add 0 at end; will hold timezone marking
