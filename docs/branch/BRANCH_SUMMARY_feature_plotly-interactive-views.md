...
- CrossSection Plotly Part 3: parity polish, examples, magnitude legend UX.
...
## Validation
- `pytest tests/test_cross_section_plotly_data.py tests/test_cross_section_plotly_figure.py tests/test_maps_stack_smoke.py` (local).
