...
- Author **`gallery/SwarmMPL/Clipboard_tutorial_bokeh.ipynb`** reproducing Tutorial A **Examples 1–3** on the Bokeh clipboard API.
...
- Pending implementation: Bokeh Clipboard module, tests, and **`gallery/SwarmMPL/Clipboard_tutorial_bokeh.ipynb`** per **`docs/plans/bokeh-swarm-clipboard-plan.md`**.
