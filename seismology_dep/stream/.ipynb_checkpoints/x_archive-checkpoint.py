...
def archive( ds, nslc_list, tstart, tend,
            basedir='./',
    ...
    Input arguments:
        ...
        ds                     : datasourse : jjwutils datasource formatted string
        ...
        reclen                 : int : Should be set to the desired data record length in bytes which must be expressible as 2 raised to the power of X where X is between (and including) 8 to 20
        ...
        nslc_list_out          : list or str : list of NSLC strings to replace in archived files (or just one string) 
    ...
    from seismology.stream.datasource import createClient, datasource
    ...
    print('Archiving data from : {}'.format(ds))
